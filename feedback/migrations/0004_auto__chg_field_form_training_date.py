...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Form.training_date'
        db.alter_column(u'form', 'training_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'Form.training_date'
        db.alter_column(u'form', 'training_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'feedback.form': {
            ...
            'training_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
